...
// couponSchema.methods.checkIfUsedByUser = function (user_id) {
//   const id = new Types.ObjectId(user_id);
//   const isUsed = this.used_by.includes(id);
//   return isUsed;
// };

// couponSchema.methods.addToUsedBy = async function (user_id) {
//   const id = new Types.ObjectId(user_id);
//   this.used_by.push(id);
//   this.max_use--;
//   await this.save();
...
// couponSchema.methods.decreaseMaxUse = async function () {
//   this.max_use--;
//   await this.save();
// };

// couponSchema.methods.increaseMaxUse = async function () {
//   this.max_use++;
//   await this.save();
// };

// couponSchema.methods.removeFromUsedBy = async function (user_id) {
//   const userID = new Types.ObjectId(user_id);
//   const index = this.used_by.findIndex(
//     (ele) => ele.prototype.toString() === user_id
//   );
//   this.used_by.splice(index, 1);
//   this.max_use++;
//   await this.save();
